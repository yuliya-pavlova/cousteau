class ImagePopup extends Popup {
    ...
    параметров - Вы лучше знаете свой код и разберётесь с этим.(исправлено)
    ...
    удаления камрточки. В этом же классе этот обработчик должен удаляться при удалении карточки. (исправлено)
    ...
    принять аргумент this.link, тогда можно будет записать выражение this.popupImage.src = link и не делать никаких вычислений src.(исправлено)*/
    _open(link) {
        ...
        во избежание дублирования кода. (исправлено) */
